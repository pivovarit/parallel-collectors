 ...
 *
 * @implNote this class represents {@link ParallelCollectors} alternatives that process {@link Stream} elements in batches instead of processing each item separately
 *
 * @author Grzegorz Piwowarek
 */
public final class BatchingParallelCollectors {

    private BatchingParallelCollectors() {
    }
